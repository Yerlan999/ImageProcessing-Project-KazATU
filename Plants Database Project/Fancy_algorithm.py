...
img = cv2.imread("101w.jpg")  # Change the image path to your own
...
# 200 is the size of the connected region to be eliminated.
im2 = baweraopen(eroded, 180)
#---------------------------------------------------------------------------------
...
#distance is 50
distance_top = 22
Area = (pow((0.000122 * (distance_top - 0.304) / 0.304), 2)
        * len(im2.nonzero()[0]))
